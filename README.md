...
High-performance Laplacian of Gaussian edge detection for QGIS raster datasets. [![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=roko-gis_LoG-Filter-Professional-Edge-Detection&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=roko-gis_LoG-Filter-Professional-Edge-Detection)
## Citation
